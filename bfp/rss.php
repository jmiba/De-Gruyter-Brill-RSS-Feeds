    ...
    if ($context === null) {
        $context = stream_context_create([
            "http" => [
                "method" => "GET",
                "header" => implode("\r\n", [
                    "User-Agent: Mozilla/5.0 (compatible; BFP-RSS/1.0; +https://www.jensmittelbach.de/bfp/rss.php)",
...
function fetchDegruyterArticles() {
    ...
    $url = $baseUrl . "/journal/key/bfup/0/0/html";
    $html = fetchUrl($url);
...
function generateRSS($articles) {
    ...
    $rssFeed .= "<channel>\n";
    $rssFeed .= "<title>Ahead of Print: Bibliothek – Forschung und Praxis</title>\n";
    $rssFeed .= "<link>https://www.degruyterbrill.com/journal/key/bfup/0/0/html</link>\n";
    $rssFeed .= "<atom:link href='" . htmlspecialchars($self_url) . "' rel='self' type='application/rss+xml'/>\n";
    $rssFeed .= "<description>Ahead-of-print-Artikel in Bibliothek – Forschung und Praxis</description>\n";
